...
class __TwigTemplate_1c9b0528af2f6369255f685e3f2f9a3f extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"col-md-6 col-lg-4\">
        ...
        echo "
            <div class=\"form-group\">
                 ";
        // line 30
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 30, $this->source); })()), "email", [], "any", false, false, false, 30), 'row');
        echo "
            </div>
            <div class=\"form-group\">
                ";
...
";
    ...
    {
        return array (  125 => 39,  120 => 37,  116 => 35,  114 => 33,  108 => 30,  103 => 28,  90 => 17,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}", "registration/register.html.twig", "C:\\symfonyproject\\templates\\registration\\register.html.twig");
    }
}
