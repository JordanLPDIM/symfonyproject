...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\WeatherController2' => 'getWeatherController2Service',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HMYBFJPmjl', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6SmZo4zgJM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AbwHWnsqwY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(($this->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => 'C:\\symfonyproject\\src\\Entity'])), 'App\\Entity');
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\TweetsRepository' => ['privates', 'App\\Repository\\TweetsRepository', 'getTweetsRepositoryService', true],
     ...
     */
    protected function get_ServiceLocator_YZnLB1sService()
    {
        return $this->privates['.service_locator.yZnLB1s'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getAssets_PackagesService()
    {
        ...
        return $this->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy('C:\\symfonyproject/public/build/manifest.json', ($this->privates['.debug.http_client'] ?? $this->get_Debug_HttpClientService()), false), new \Symfony\Component\Asset\Context\RequestStackContext(($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a->getBaseUrl(), $a->isSecure())), new RewindableGenerator(function () {
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rzN0ou9goP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('f1k8Rb8mGo', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7QY3xs+pPP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7DZRwiglbK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i+HC7R3FEI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CA7x5SX7kl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('04FOfu446S', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['debug.file_link_formatter'] = new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter($this->getEnv('default::SYMFONY_IDE'), ($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'C:\\symfonyproject', #[\Closure(name: 'debug.file_link_formatter.url_format', class: 'string')] function () {
    ...
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($this->privates['.service_locator.yZnLB1s'] ?? $this->get_ServiceLocator_YZnLB1sService()), new RewindableGenerator(function () {
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), new \Symfony\Component\Translation\Formatter\MessageFormatter(new \Symfony\Component\Translation\IdentityTranslator()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => true, 'resource_files' => ['af' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.af.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.af.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.af.xlf'], 'ar' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.ar.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.ar.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.ar.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ar.xlf'], 'az' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.az.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.az.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.az.xlf'], 'be' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.be.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.be.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.be.xlf'], 'bg' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.bg.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.bg.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.bg.xlf'], 'bs' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.bs.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.bs.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.bs.xlf'], 'ca' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.ca.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.ca.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.ca.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ca.xlf'], 'cs' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.cs.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.cs.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.cs.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.cs.xlf'], 'cy' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.cy.xlf'], 'da' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.da.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.da.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.da.xlf'], 'de' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.de.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.de.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.de.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.de.xlf'], 'el' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.el.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.el.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.el.xlf'], 'en' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.en.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.en.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.en.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.en.xlf'], 'es' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.es.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.es.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.es.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.es.xlf'], 'et' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.et.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.et.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.et.xlf'], 'eu' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.eu.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.eu.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.eu.xlf'], 'fa' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.fa.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.fa.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.fa.xlf'], 'fi' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.fi.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.fi.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.fi.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.fi.xlf'], 'fr' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.fr.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.fr.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.fr.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.fr.xlf'], 'gl' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.gl.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.gl.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.gl.xlf'], 'he' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.he.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.he.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.he.xlf'], 'hr' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.hr.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.hr.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.hr.xlf'], 'hu' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.hu.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.hu.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.hu.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.hu.xlf'], 'hy' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.hy.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.hy.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.hy.xlf'], 'id' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.id.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.id.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.id.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.id.xlf'], 'it' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.it.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.it.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.it.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.it.xlf'], 'ja' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.ja.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.ja.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.ja.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ja.xlf'], 'lb' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.lb.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.lb.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.lb.xlf'], 'lt' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.lt.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.lt.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.lt.xlf'], 'lv' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.lv.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.lv.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.lv.xlf'], 'mn' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.mn.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.mn.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.mn.xlf'], 'my' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.my.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.my.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.my.xlf'], 'nb' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.nb.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.nb.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.nb.xlf'], 'nl' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.nl.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.nl.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.nl.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle+intl-icu.nl.xlf'], 'nn' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.nn.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.nn.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.nn.xlf'], 'no' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.no.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.no.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.no.xlf'], 'pl' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.pl.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.pl.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.pl.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.pl.xlf'], 'pt' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.pt.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.pt.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.pt.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.pt.xlf'], 'pt_BR' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.pt_BR.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.pt_BR.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.pt_BR.xlf'], 'ro' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.ro.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.ro.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.ro.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ro.xlf'], 'ru' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.ru.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.ru.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.ru.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.ru.xlf'], 'sk' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.sk.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.sk.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.sk.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.sk.xlf'], 'sl' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.sl.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.sl.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.sl.xlf'], 'sq' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.sq.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.sq.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.sq.xlf'], 'sr_Cyrl' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Cyrl.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.sr_Cyrl.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Cyrl.xlf'], 'sr_Latn' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.sr_Latn.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.sr_Latn.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.sr_Latn.xlf'], 'sv' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.sv.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.sv.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.sv.xlf'], 'th' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.th.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.th.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.th.xlf'], 'tl' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.tl.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.tl.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.tl.xlf'], 'tr' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.tr.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.tr.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.tr.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.tr.xlf'], 'uk' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.uk.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.uk.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.uk.xlf', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.uk.xlf'], 'ur' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.ur.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.ur.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.ur.xlf'], 'uz' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.uz.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.uz.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.uz.xlf'], 'vi' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.vi.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.vi.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.vi.xlf'], 'zh_CN' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.zh_CN.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.zh_CN.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.zh_CN.xlf'], 'zh_TW' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations\\validators.zh_TW.xlf', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations\\validators.zh_TW.xlf', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations\\security.zh_TW.xlf'], 'sr' => [0 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations\\VerifyEmailBundle.sr.xlf']], 'scanned_directories' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations', 4 => 'C:\\symfonyproject/translations', 5 => 'C:\\symfonyproject\\vendor\\symfony\\framework-bundle/translations', 6 => 'C:\\symfonyproject\\vendor\\doctrine\\doctrine-bundle/translations', 7 => 'C:\\symfonyproject\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 8 => 'C:\\symfonyproject\\vendor\\symfony\\debug-bundle/translations', 9 => 'C:\\symfonyproject\\vendor\\symfony\\twig-bundle/translations', 10 => 'C:\\symfonyproject\\vendor\\symfony\\web-profiler-bundle/translations', 11 => 'C:\\symfonyproject\\vendor\\twig\\extra-bundle/translations', 12 => 'C:\\symfonyproject\\vendor\\symfony\\security-bundle/translations', 13 => 'C:\\symfonyproject\\vendor\\symfony\\monolog-bundle/translations', 14 => 'C:\\symfonyproject\\vendor\\symfony\\maker-bundle\\src/translations', 15 => 'C:\\symfonyproject\\vendor\\sensio\\framework-extra-bundle\\src/translations', 16 => 'C:\\symfonyproject\\vendor\\symfony\\webpack-encore-bundle\\src/translations'], 'cache_vary' => ['scanned_directories' => [0 => 'C:\\symfonyproject\\vendor\\symfony\\validator/Resources/translations', 1 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/translations', 2 => 'C:\\symfonyproject\\vendor\\symfony\\security-core/Resources/translations', 3 => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src/Resources/translations', 4 => 'translations', 5 => 'C:\\symfonyproject\\vendor\\symfony\\framework-bundle/translations', 6 => 'C:\\symfonyproject\\vendor\\doctrine\\doctrine-bundle/translations', 7 => 'C:\\symfonyproject\\vendor\\doctrine\\doctrine-migrations-bundle/translations', 8 => 'C:\\symfonyproject\\vendor\\symfony\\debug-bundle/translations', 9 => 'C:\\symfonyproject\\vendor\\symfony\\twig-bundle/translations', 10 => 'C:\\symfonyproject\\vendor\\symfony\\web-profiler-bundle/translations', 11 => 'C:\\symfonyproject\\vendor\\twig\\extra-bundle/translations', 12 => 'C:\\symfonyproject\\vendor\\symfony\\security-bundle/translations', 13 => 'C:\\symfonyproject\\vendor\\symfony\\monolog-bundle/translations', 14 => 'C:\\symfonyproject\\vendor\\symfony\\maker-bundle\\src/translations', 15 => 'C:\\symfonyproject\\vendor\\sensio\\framework-extra-bundle\\src/translations', 16 => 'C:\\symfonyproject\\vendor\\symfony\\webpack-encore-bundle\\src/translations']]], []);
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'C:\\symfonyproject');
        $a->addPath('C:\\symfonyproject\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('C:\\symfonyproject\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('C:\\symfonyproject\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('C:\\symfonyproject\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\debug-bundle/Resources/views', 'Debug');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\debug-bundle/Resources/views', '!Debug');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\web-profiler-bundle/Resources/views', 'WebProfiler');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\web-profiler-bundle/Resources/views', '!WebProfiler');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('C:\\symfonyproject/templates');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\twig-bridge/Resources/views/Email', 'email');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\twig-bridge/Resources/views/Email', '!email');
        $a->addPath('C:\\symfonyproject\\vendor\\symfony\\twig-bridge/Resources/views/Form');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension($d, 'C:\\symfonyproject', 'UTF-8'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings([0 => 'C:\\symfonyproject\\vendor\\symfony\\form/Resources/config/validation.xml']);
    ...
    {
        return [
            'kernel.project_dir' => 'C:\\symfonyproject',
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
                'DoctrineBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\doctrine\\doctrine-bundle',
                    'namespace' => 'Doctrine\\Bundle\\DoctrineBundle',
                ],
                'DoctrineMigrationsBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\doctrine\\doctrine-migrations-bundle',
                    'namespace' => 'Doctrine\\Bundle\\MigrationsBundle',
                ],
                'DebugBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\debug-bundle',
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'TwigBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\twig-bundle',
                    'namespace' => 'Symfony\\Bundle\\TwigBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\web-profiler-bundle',
                    'namespace' => 'Symfony\\Bundle\\WebProfilerBundle',
                ],
                'TwigExtraBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\twig\\extra-bundle',
                    'namespace' => 'Twig\\Extra\\TwigExtraBundle',
                ],
                'SecurityBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\security-bundle',
                    'namespace' => 'Symfony\\Bundle\\SecurityBundle',
                ],
                'MonologBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\monolog-bundle',
                    'namespace' => 'Symfony\\Bundle\\MonologBundle',
                ],
                'MakerBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\maker-bundle\\src',
                    'namespace' => 'Symfony\\Bundle\\MakerBundle',
                ],
                'SensioFrameworkExtraBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\sensio\\framework-extra-bundle\\src',
                    'namespace' => 'Sensio\\Bundle\\FrameworkExtraBundle',
                ],
                'WebpackEncoreBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfony\\webpack-encore-bundle\\src',
                    'namespace' => 'Symfony\\WebpackEncoreBundle',
                ],
                'SymfonyCastsVerifyEmailBundle' => [
                    'path' => 'C:\\symfonyproject\\vendor\\symfonycasts\\verify-email-bundle\\src',
            ...
            'translator.default_path' => 'C:\\symfonyproject/translations',
            ...
            'twig.default_path' => 'C:\\symfonyproject/templates',
